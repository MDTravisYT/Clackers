...
Obj_RedSpring_Up:				
		...
		move.l	#Map_SpringUp,obMap(a6)			; 	set mappings to use
		move.w	#$0407,obVRAM(a6)					;	set VRAM location
		move.w	#$8080,4(a6)					
		move.b	#$10,obWidth(a6)					;	set width of solid object (16)
		move.b	#$08,obHeight(a6)					;	set height of solid object (8)
...
Obj04_TalSetAni:
		move.b	#$A8,d0							;	set SFX ID
		jsr		Play_Sound						;	play SFX
		ori.w	#$01,obFlags(a6)					;	set flags to animate spring
		move.l	#$000F0000,d1					;	set the power of the spring
		neg.l	d1								;	clear d1
		moveq	#$00,d0
		jsr	(SpeedToPos).l

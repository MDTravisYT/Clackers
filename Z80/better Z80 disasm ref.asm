...
loc_78C:				; CODE XREF: DoPause+24j
		ld	c, (ix+0Ah)
		ld	a, 0B4h
		rst	WriteFMIorII
...
SendSSGEG:				; CODE XREF: PlaySoundID:loc_C91p
		ld	hl, SSGEG_Ops
		ld	b, 4

loc_E0C:				; CODE XREF: SendSSGEG+Bj
		ld	a, (de)
		inc	de
		ld	c, a
		ld	a, (hl)
...
stru_11EC:	DACTable <30h, 4, 1D4h,	8000h> ; DATA XREF: RAM:DACTablePtrso
stru_11F2:	DACTable <0Ah, 4, 0DDEh, 81D4h>	; DATA XREF: RAM:DACTablePtrso
stru_11F8:	DACTable <0Ah, 4, 6C0h,	8FB2h> ; DATA XREF: RAM:DACTablePtrso
stru_11FE:	DACTable <0Eh, 4, 6C0h,	8FB2h> ; DATA XREF: RAM:DACTablePtrso
stru_1204:	DACTable <10h, 4, 6C0h,	8FB2h> ; DATA XREF: RAM:DACTablePtrso
stru_120A:	DACTable <0Ah, 4, 157Ch, 9672h>	; DATA XREF: RAM:DACTablePtrso
stru_1210:	DACTable <0Ah, 4, 18B4h, 0ABEEh> ; DATA	XREF: RAM:DACTablePtrso
		ds 9EAh
		ds 1
		ds 1
		ds 1
		ds 1
byte_1C04:	ds 1			; DATA XREF: RAM:00C3w	UpdateAll+13o ...
byte_1C05:	ds 1			; DATA XREF: RAM:006Aw	RAM:0077o ...
byte_1C06:	ds 1			; DATA XREF: DoFading+3Ao
					; StopAllSound+24w ...
		ds 1
		ds 1
...
unk_1C0A:	ds 1			; DATA XREF: StopAllSound+3o
		...
		ds 1
		ds 1
byte_1C0D:	ds 1			; DATA XREF: DoPause+13r RAM:07BBw ...
byte_1C0E:	ds 1			; DATA XREF: RAM:07C3w
					; DoFading:loc_7EEr
byte_1C0F:	ds 1			; DATA XREF: RAM:07C0w	DoFading+Br ...
unk_1C10:	ds 1			; DATA XREF: DoPauseo
byte_1C11:	ds 1			; DATA XREF: DoPause:loc_780r
					; RAM:cf02_MusPausew
byte_1C12:	ds 1			; DATA XREF: StopAllSound+38w
					; SendFM3SpcModew
byte_1C13:	ds 1			; DATA XREF: PlaySoundID+8Fw
					; DoTempo+3o ...
byte_1C14:	ds 1			; DATA XREF: PlaySoundID+92w DoTempor	...
byte_1C15:	ds 1			; DATA XREF: PlaySoundID+159w
					; PlaySoundID+6E6w
...
word_1C33:	ds 2			; DATA XREF: PlaySoundID+99w
					; PlaySoundID+B8r ...
word_1C35:	ds 2			; DATA XREF: PlaySoundID+9Fw
					; PlaySoundID+ACr ...
word_1C37:	ds 2			; DATA XREF: GetFMInsPtrr
					; PlaySoundID+86w ...
word_1C39:	ds 2			; DATA XREF: PlaySoundID+155w
					; PlaySoundID+1B0r
byte_1C3B:	ds 1			; DATA XREF: PlaySoundID+163w
					; PlaySoundID+18Dr
byte_1C3C:	ds 1			; DATA XREF: RAM:0043r	RAM:0054o ...
		ds 1
		ds 1
		ds 1
byte_1C40:	ds 1			; DATA XREF: UpdateAll+29o
					; PlaySoundID+A2o ...
		ds 1
unk_1C42:	ds 1			; DATA XREF: RAM:0DF0o
		ds 1
		ds 1
		ds 1
		ds 1
...
unk_1C4B:	ds 1			; DATA XREF: DoTempo+9o
		...
		ds 1
		ds 1
unk_1C70:	ds 1			; DATA XREF: UpdateAll+36o
		ds 1
		ds 1
		ds 1
		ds 1
...
byte_1D60:	ds 1			; DATA XREF: StopDrumPSG+4w
		...
		ds 1
		ds 1
byte_1D90:	ds 1			; DATA XREF: PlaySoundID+DAo
					; StopDrumPSG+Aw
		ds 1
		ds 1
		ds 1
